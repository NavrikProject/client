    ...
    const getAllCourse = async () => {
      try {
        const response = await axios.get(
          "https://navriktrainingserverside.azurewebsites.net/api/courses/all-courses"
        );
        if (!response.data) {
          return;
        }
  ...
  useEffect(() => {
    const getCourseByCatCourse = async () => {
      try {
        const response = await axios.get(
          searchItemAll
            ? `https://navriktrainingserverside.azurewebsites.net/api/courses/search?name=${searchItemAll}`
            : `https://navriktrainingserverside.azurewebsites.net/api/courses/all-courses`
        );
        if (!response.data) {
          return;
