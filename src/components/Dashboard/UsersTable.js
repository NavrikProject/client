...
const UsersTable = () => {
  ...
  const trainerApproveHandler = async (trainer) => {
    const res = await axios.put(
      `https://navriktrainingserverside.azurewebsites.net/api/trainer/update/approve/${trainer.trainer_id}`,
      {
        headers: { authorization: "Bearer " + token },
      }
    );
  ...
  const trainerDisApproveHandler = async (trainer) => {
    const res = await axios.put(
      `https://navriktrainingserverside.azurewebsites.net/api/trainer/update/disapprove/${trainer.trainer_id}`,
      {
        headers: { authorization: "Bearer " + token },
      }
    );
